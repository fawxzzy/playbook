export const commandMetadata = [
    ...
    {
        name: "workers",
        description: "Assign deterministic proposal-only workers, derive launch authorization, and submit worker results from lane-state/workset artifacts",
        category: "Core",
        role: "remediation",
        lifecycle: "canonical",
        discoverability: "primary",
    ...
    {
        name: "ai",
        description: "Emit proposal-only AI artifacts from deterministic context and contract surfaces",
        category: "Repository tools",
        role: "bootstrap",
        lifecycle: "canonical",
        discoverability: "primary",
    ...
    },
    {
        ...
        description: "Inspect recent test-autofix remediation history, repeat-policy decisions, and retry guidance",
        category: "Repository tools",
        role: "remediation",
        lifecycle: "canonical",
        discoverability: "secondary",
    ...
    {
        name: "rendezvous",
        description: "Create/status/release-dry-run artifact rendezvous readiness from canonical remediation artifacts",
        category: "Repository tools",
        role: "remediation",
        lifecycle: "canonical",
        discoverability: "secondary",
    ...
    {
        name: "interop",
        description: "Inspect and run remediation-first Playbook↔Lifeline interop contracts from rendezvous artifacts",
        category: "Repository tools",
        role: "remediation",
        lifecycle: "canonical",
        discoverability: "secondary",
    ...
    {
        name: "changelog",
        description: "Generate, validate, and safely append deterministic WHAT/WHY changelog entries",
        category: "Repository tools",
        role: "governance",
        lifecycle: "canonical",
        discoverability: "secondary",
    ...
    {
        name: "receipt",
        description: "Ingest explicit execution results into receipt, updated-state, and next-queue",
        category: "Utility",
        role: "utility",
        lifecycle: "canonical",
        discoverability: "secondary",
...
export const getCommandMetadata = (name) => commandMetadata.find((command) => command.name === name);
