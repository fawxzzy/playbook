...
## 0.52.0 - 2026-05-19
- Recommended bump: minor
- @fawxzzy/playbook: 0.51.0 -> 0.52.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.51.0 -> 0.52.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.51.0 -> 0.52.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.51.0 -> 0.52.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.51.0 -> 0.52.0 (playbook-installable-workspace)

## 0.51.0 - 2026-05-19
- Recommended bump: minor
- @fawxzzy/playbook: 0.50.0 -> 0.51.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.50.0 -> 0.51.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.50.0 -> 0.51.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.50.0 -> 0.51.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.50.0 -> 0.51.0 (playbook-installable-workspace)
...
- @fawxzzy/playbook-cli: 0.48.0 -> 0.49.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.48.0 -> 0.49.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.48.0 -> 0.49.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.48.0 -> 0.49.0 (playbook-installable-workspace)

## 0.48.0 - 2026-05-10
- Recommended bump: minor
- @fawxzzy/playbook: 0.47.0 -> 0.48.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.47.0 -> 0.48.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.47.0 -> 0.48.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.47.0 -> 0.48.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.47.0 -> 0.48.0 (playbook-installable-workspace)

## 0.47.0 - 2026-05-09
- Recommended bump: minor
- @fawxzzy/playbook: 0.46.0 -> 0.47.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.46.0 -> 0.47.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.46.0 -> 0.47.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.46.0 -> 0.47.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.46.0 -> 0.47.0 (playbook-installable-workspace)

## 0.46.0 - 2026-05-09
- Recommended bump: minor
- @fawxzzy/playbook: 0.45.0 -> 0.46.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.45.0 -> 0.46.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.45.0 -> 0.46.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.45.0 -> 0.46.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.45.0 -> 0.46.0 (playbook-installable-workspace)
...
## 0.45.0 - 2026-05-07
- Recommended bump: minor
- @fawxzzy/playbook: 0.44.0 -> 0.45.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.44.0 -> 0.45.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.44.0 -> 0.45.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-engine: 0.44.0 -> 0.45.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-node: 0.44.0 -> 0.45.0 (playbook-installable-workspace)

## 0.44.0 - 2026-05-07
- Recommended bump: minor
- @fawxzzy/playbook: 0.43.0 -> 0.44.0 (playbook-installable-workspace)
- @fawxzzy/playbook-cli: 0.43.0 -> 0.44.0 (playbook-installable-workspace)
- @zachariahredfield/playbook-core: 0.43.0 -> 0.44.0 (playbook-installable-workspace)
...
## Unreleased
- WHAT: Repaired the `PB-V1-DELIVERY-SYSTEM-001` CLI smoke contract so the intentionally incomplete fresh-init fixture runs `doctor --json`, admits only diagnostic exit `1`, and validates the error status, positive error summary, expected failure domains, contract-validation blocker, structured Docs finding, empty stderr, and normal process completion. Added focused harness rejection coverage for crash-shaped stderr, malformed JSON, and unexpected failure domains, while strengthening Doctor's existing fail-closed contract proof. WHY: The CLI smoke harness was created while Doctor was temporarily informational and was not updated when severity-based exit semantics were restored, leaving `pnpm test:cli` stale against the intentional Doctor contract.
...
- WHAT: Recorded first `v0.1.2` fallback proof outcomes from this branch run: producer proof currently fails with release asset download HTTP 403 (`playbook-cli-0.1.2.tgz` unavailable) and the provided consumer path proof command fails with local path `ENOENT` (`./target-repo` was not mounted in that environment). WHY: Makes producer/consumer proof status explicit until the tagged release is published and consumer validation is rerun in an environment with the target repo path.
...
- WHAT: Updated `pnpm start:lifeline` to create the portable global target `../../runtime/playbook/observer` through a fail-closed Lifeline-only preflight before selecting it and passing the explicit Observer root `.`, added clean-topology, preflight-failure, and graceful-stop regression proof, and documented the runtime-home boundary. WHY: A supervisor-owned lifecycle must work from a fresh runtime layout and keep both Observer state and Playbook runtime telemetry out of the source checkout, including when `endRuntimeCycle` runs after a normal graceful stop.
- Rule: Runtime homes are explicit; a supervisor-owned start surface must pass the canonical runtime home explicitly.
- Pattern: Stable repository working directory + idempotent relative runtime-home creation + portable global target + explicit Observer-local root -> deterministic registry and lifecycle telemetry placement outside the source checkout.
- Failure Mode: Source-checkout runtime leakage occurs when a command-local root moves Observer state but the top-level lifecycle still inherits repository cwd for telemetry.
